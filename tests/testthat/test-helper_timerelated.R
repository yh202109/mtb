...
test_that("function_dt_plot_event_1", {
  ...
  expect_equal( names(p$data), c('id','start','end','label','type','idn','yloc','yloc2') )
  expect_equal( names(p$labels), c('x','yintercept','label','hjust','vjust','y','xend','yend','xmin','xmax','ymin','ymax') )
})
