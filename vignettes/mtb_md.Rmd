...
These formatting functions help to emphasize a sentence, or a paragraph.
`add_colored_str()` adds an inline string with customized styles, including color, background color, and size.
`add_colored_box()` adds a colored area with a title to emphasize a reminder, or a warning.
